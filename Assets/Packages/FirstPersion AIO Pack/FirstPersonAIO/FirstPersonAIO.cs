...
public class FirstPersonAIO : MonoBehaviour {
    ...
    public enum CameraInputMethod {
        Traditional, TraditionalWithConstraints, Retro
    }
    ...
    public override void OnInspectorGUI() {
        ...
        */
        ...
        if (!loadedAds) {
            ...
            if (GUILayout.Button(adTex1, new GUIStyle() { stretchWidth = true, fixedHeight = 64, alignment = TextAnchor.MiddleCenter })) {
                Application.OpenURL("https://assetstore.unity.com/packages/templates/systems/infinigun-universal-fps-firearm-153247");
            }
        }
